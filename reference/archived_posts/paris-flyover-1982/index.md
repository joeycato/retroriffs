...
In April of 1982, my small hometown of Paris, Texas was devastated by a huge tornado. 
This year marks the 40th anniversary.

This event was significant enough to make national news and through some research I was able to find a helicopter flyover from that time.
What you see in the video is actually B-roll video of a downtown flyover.
...
_Note:_ The **-ss**, **-t** arguments also support the _hh:mm:ss_ format. I just chose to use _seconds_ in my case because it was simpler to directly export those units from the editor.

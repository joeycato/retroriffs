...
I learned a great deal while making this game. For example, I found that creating the level editor as the very first step made it much easier to scope out and visualize the game world. This led me to quickly reconsider the game objects I had initially planned. Had I waited until later, it would have taken me much longer to complete the game. I also learned what not to do. By this, I’m referring to MFC/GDI, which I used exclusively for the graphics and animations (with the exception of OpenGL for the 3D-rendered walls). I was able to mitigate some of its performance issues by employing sprite sheets, but things would have been much smoother in the long run with hardware-accelerated graphics.
